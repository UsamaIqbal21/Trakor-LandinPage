        ...
        <div className="container mx-auto flex flex-col md:flex-row  rounded-lg border border-[#475569]">
          <div className="flex flex-col items-center justify-center  px-4 ">
            <div className="flex flex-col items-start justify-center gap-y-8 md:gap-y-4 pt-4  md:py-6 lg:py-8 md:pl-4 lg:w-[608px] ">
              <div>
                <h3 className="text-white font-medium text-lg xl:text-3xl 2xl:text-4xl leading-110">
              ...
              <div>
                <div className="rounded-md border border-[#475569] bg-[#334155] w-[152px] md:w-[172px] py-2">
          ...
          <div className="pt-8 md:pt-40 lg:pt-24 lg:w-[608px] 2xl:w-full">
