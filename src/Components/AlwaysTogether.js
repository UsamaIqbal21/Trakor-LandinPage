      ...
      <div className="pt-0 pb-20">
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center justify-center gap-y-8">
            <div>
              <div>
                <h3 className="text-white text-center text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-roboto font-extrabold leading-tight">
                  Your team. Your projects.
                </h3>
              </div>
              <div>
                <h5 className="text-[#818CF8] text-center text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-roboto font-medium leading-tight">
                  Always together.
                </h5>
              </div>
            </div>
