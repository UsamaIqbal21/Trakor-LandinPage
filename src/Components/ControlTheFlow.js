          ...
          <div>
            <div className="flex flex-col md:flex-row items-start md:items-center justify-center gap-y-8 md:gap-y-0 md:gap-x-4 lg:gap-x-8 xl:gap-x-12 2xl:gap-x-20">
              <div className="flex flex-col gap-y-8 md:w-[600px]">
                <div>
                  <h3 className="text-white  font-roboto text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl font-semibold leading-110" data-aos="fade-up">
                    Control the flow.
                  </h3>
                  <h3 className="text-[#818CF8] font-roboto text-2xl lg:text-2xl xl:text-3xl 2xl:text-4xl font-bold leading-110" data-aos="fade-up" data-aos-delay="100">
                    Work faster.
                  </h3>
                </div>
                <div>
                  <p className="font-roboto text-white text-sm font-normal leading-140" data-aos="fade-up" data-aos-delay="200">
                ...
                <div className="w-[186px]">
                  <div className=" rounded-md border-1 border-[#6366F1] bg-[#4F46E5]  p-2" data-aos="fade-up" data-aos-delay="300">
              ...
              <div className="md:w-[680px]" data-aos="fade-up"data-aos-delay="400" >
