...
function PowerFullTools() {
  return (
    <section className="relative">
      <div className="absolute top-[-50px] md:top-[-100px] 2xl:top-[-120px] px-4 md:px-16 lg:px-32 xl:px-44 2xl:px-96 ">
          ...
          <div>
            <div className="flex flex-col md:flex-row-reverse items-center justify-center gap-y-8 md:gap-y-0 md:gap-x-12 lg:gap-x-12 xl:gap-x-16 2xl:gap-x-20">
              <div className="flex flex-col items-start justify-center gap-y-4  lg:gap-y-8 md:w-[600px]">
                <div>
                  <div>
                    <h3 className="text-white font-roboto font-bold text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl leading-110">
                      Powerful tools.
                    </h3>
                  </div>
                  <div>
                    <h3 className="text-[#818CF8] font-roboto font-semibold text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl leading-tight">
                      More control.
                    </h3>
                  </div>
                </div>
                <div className="xl:pr-12">
                  <p className="text-[#CBD5E1] font-roboto text-base font-normal leading-140">
